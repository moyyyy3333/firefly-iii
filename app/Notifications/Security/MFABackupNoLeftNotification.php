...
class MFABackupNoLeftNotification extends Notification
{
    ...
    public function toMail(User $notifiable): MailMessage
    {
        ...
        return new MailMessage()
            ->markdown('emails.security.no-backup-codes', [
                'user'      => $this->user,
                'ip'        => $ip,
                'host'      => $host,
                'userAgent' => $userAgent,
    ...
    {
        return PushoverMessage::create((string) trans('email.mfa_few_backups_left_slack', ['email' => $this->user->email]))->title((string) trans(
    ...
    {
        return (string) trans('email.mfa_no_backups_left_slack', ['email' => $this->user->email]);
    }
