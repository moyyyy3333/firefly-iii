...
class EnabledMFANotification extends Notification
{
    ...
    public function toMail(User $notifiable): MailMessage
    {
        ...
        return new MailMessage()
            ->markdown('emails.security.enabled-mfa', [
                'user'      => $this->user,
                'ip'        => $ip,
                'host'      => $host,
                'userAgent' => $userAgent,
    ...
    {
        return PushoverMessage::create((string) trans('email.enabled_mfa_slack', ['email' => $this->user->email]))->title((string) trans(
            'email.enabled_mfa_subject'
        ));
    }
    ...
    {
        return (string) trans('email.enabled_mfa_slack', ['email' => $this->user->email]);
    }
